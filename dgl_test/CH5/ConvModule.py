...
class GraphConv(nn.Module):
    ...
    Description
    -----------
    Original from GraphSAGE: layer from paper `Inductive Representation Learning on
    Large Graphs
    ...
    # >>> feat = th.ones(6, 10)  # node number; feature length
    # >>> conv = GraphConv(10, 2, 'pool')
    # >>> res = conv(g, feat)
    # >>> res
    ...
    def forward(self, graph, feat, edge_weight=None):
        ...
        with graph.local_scope():
            ...
            # Message Passing (Depending on agg function (type))
