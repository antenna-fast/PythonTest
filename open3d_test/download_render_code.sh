...
remote_path='/data0/texture_data/yaohualiu/project_info/ANTennaDepthRender'
local_path="/Users/aibee/PycharmProjects/pythonProject/test/open3d_test"
mkdir ${local_path}

scp -r root@192.168.90.101:${remote_path} ${local_path}
